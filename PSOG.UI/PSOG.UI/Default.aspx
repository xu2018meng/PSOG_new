<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="Default.aspx.cs" Inherits="_Default_new2" %>
...
window.onload =function(){
    $("#left_frame").attr("src", "aspx/tree_plant_new2.aspx"); 
}
...
//在主区域显示不同的页面
function showMainPage(id,type){
   if("main" == type){//点击主页
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/main_page.aspx?plantId=" +plantId;
   }else if("realAlarm" == type){//实时报警
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/alarm_parameter.aspx?plantId="+plantId+"&sys_menu_code=009";
   ...
   }else if("alarmSurvey" == type){//报警评估
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/alarm_analysis.aspx?plantId="+plantId;
   }else if("changeApply" == type){//变更申请
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/craft_param_change_apply.aspx?plantId="+plantId;
   }else if("changeExam" == type){
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/craft_param_change_exam.aspx?plantId="+plantId;
   }else if("changeRecord" == type){
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/craft_param_change_record.aspx?plantId="+plantId;
   }else if("graphic" == type){//图形监控
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/graphic_monitor.aspx?plantId="+plantId;
   }
}

//在主区域显示不同的页面
function showMainPage2(id,type){
   if("main" == type){//点击主页
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/main_page_new2.aspx?plantId=" +plantId;
   }else if("device" == type){//单击设备号
       var parentInfos = id.split("#");
       var deviceId = parentInfos[0];
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/main_page_new2_detail.aspx?plantId="+plantId+"&deviceId="+deviceId;
   }else if("basemodal" == type){//根原因分析模型库
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/Web_RunState_ASDB.aspx?plantId="+plantId;
      ...
      document.getElementById("main-region").src = "aspx/operation_quality_analysis.aspx?plantId="+plantId;
       ...
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/art_check_main.aspx?plantId="+plantId;
   }else if("alarmSurvey" == type){
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/alarm_analysis.aspx?plantId="+plantId;
   }else if("alarmParam" == type){
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/craft_param_list.aspx?plantId="+plantId;
   }else if("alarmParamChange" == type){
       var parentInfos = id.split("#");
       var plantId = parentInfos[1];
       document.getElementById("main-region").src = "aspx/craft_param_change_record.aspx?plantId="+plantId;
   }
...
function changeHomePage(){
   window.location = "./Default_new2.aspx";
}
//退出
function userLogout(){
      $.ajax({
        url:"./aspx/login_out.ashx",
        method:"post",
        async:false,
        data:{},
