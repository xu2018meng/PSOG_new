<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Web_RunState_Fault_tree_new.aspx.cs" Inherits="aspx_Web_RunState_Fault_tree_new" %>
                                        ...
                                        <table style="width:100%">
                                            ...
                                            <tr style="height:380px; width:100%; vertical-align:top">
                                                <td style="background-color:Black" align=left>
                                                    <span id="name2" style="text-align:left; color:White"></span>
                                                    <input type="button" onclick="openwin()" style="position:relative;left:50%; background-color:#156482; color:White; border:none; cursor:pointer" value="查看模型" />
                                                    ...
                                                    <table id="dg_root_cause_monitoring" class="easyui-treegrid" style="width:100%;height:230px;"
		                                                ...
		                                                <thead>
			                                                <tr>
				                                                ...
				                                                <th data-options="field:'action',styler:cellStyler" width="100">建议措施</th>
			                                                </tr>
		                                                </thead>
	                                                </table>
                                                </td>
                                            ...
                                            <tr style="height:400px; width:100%; vertical-align:top">
                                                <td style="text-align:center">
                                                    <input id="imageURI" type="image" src="../resource/img/rolling.gif" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
<script type="text/javascript">
	...
	function openwin(){
	    windowOpen("./fault_tree_models/fault_tree_model.aspx?plantId=<%=plantId %>&name="+FT_modelID, '_blank');
	}
	//打开新链接方法实现
    ...
    $.ajax({
        url: 'fault_tree_models_list.html',
        dataType: "json",
        success: function(data){
            var modelID = '<%=modelId %>';
            for(var o in data){
                if(modelID == data[o].ID){
                    ...
                    FT_modelID = data[o].modelID;
                    document.getElementById("imageURI").src = "../resource/img/fault_tree_DCS_images/img"+data[o].modelID+".jpg";
                    $.ajax({
                        url: "./fault_tree_models/"+FT_modelID+".html",
                        dataType: "json",
                        success: function(data){
                            $('#dg_root_cause_monitoring').datagrid('loadData', data);
                    ...
                    document.getElementById("Img").src = './web_get_ASImg.ashx?fileId=a&plantId=<%=plantId %>&name='+FT_modelID;
                }
            }               
        }
     });
