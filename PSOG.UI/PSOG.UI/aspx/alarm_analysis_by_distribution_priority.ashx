<%@ WebHandler Language="C#" Class="alarm_analysis_by_distribution_priority" %>
...
public class alarm_analysis_by_distribution_priority : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            grid = new AlarmAnalysis().alarmAnaysisDistributionByPriority(startTime, endTime, DBName,dbSource);
        }
