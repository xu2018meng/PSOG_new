<%@ WebHandler Language="C#" Class="alarm_analysis_by_distribution_process" %>
...
public class alarm_analysis_by_distribution_process : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            grid = new AlarmAnalysis().alarmAnaysisDistributionByProcess(startTime, endTime, DBName,dbSource);
        }
