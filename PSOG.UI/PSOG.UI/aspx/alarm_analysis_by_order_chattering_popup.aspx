<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alarm_analysis_by_order_chattering_popup.aspx.cs" Inherits="alarm_analysis_by_order_chattering_popup" %>
    ...
    <div style="padding-bottom: 5px;overflow-y:hidden;" id="qryDiv"  region="north"  border="false">
        <table class="tblSearch" style="text-align:left">
            <tr style="height:auto;">                        
                ...
                指标查询：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <div style="padding:5px 0;display:inline"><a id="Chattering" style=" border:none" title="重复报警排行。" class="easyui-linkbutton easyui-tooltip" data-options="iconCls:'icon-chattering',size:'large',iconAlign:'top'"><b>重复报警</b></a></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table width="100%" height="100%">
            <tr>
                ...
                <td style="border-width:1px; width:80%">
					...
					<div id="Div_chattering" fit="true" region="center" style="padding: 5px;  height: 300px;" border="false">
...
//                    }
        ...
        function show_distribution_chattering(){   //执行报警空间分布功能
            var startTime = $("#startTime").val();
            var endTime = $("#endTime").val();
        ...
        $('#Chattering').click(function (){ //点击Top20报警按钮
            show_distribution_chattering();
