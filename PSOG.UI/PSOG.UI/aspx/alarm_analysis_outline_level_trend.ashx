<%@ WebHandler Language="C#" Class="alarm_analysis_outline_level_trend" %>
...
public class alarm_analysis_outline_level_trend : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            grid = new AlarmAnalysis().alarmAnaysisOutlineTrend(startTime, endTime, DBName, dbSource);
        }
