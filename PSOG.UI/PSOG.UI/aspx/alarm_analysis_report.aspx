<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alarm_analysis_report.aspx.cs" Inherits="aspx_alarm_analysis_report" %>
...
<body  class="easyui-layout" style="width:100%; height:100%;">
    <!-- <form id="form1" action=""> -->
        <div style="padding-bottom: 5px;overflow-y:hidden;" id="qryDiv"  region="north"  border="false">
            <table class="tblSearch" style="padding-left:8%">
                <tr style="height:auto;">                        
                   ...
                   <div style="float:left;font-weight:bold;font-size:18px;padding-top:9px;">   &nbsp;指标查询&nbsp;&nbsp;&nbsp;</div>
                              ...
                              <div style="padding:5px 0;display:inline"><a id="generate_report" style=" border:none" title="生成报表。" class="easyui-linkbutton easyui-tooltip" data-options="iconCls:'icon-level',size:'large',iconAlign:'left'"><b>生成报表</b></a></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <div style="padding:5px 0;display:inline"><a id="export_report_button" style=" border:none" title="导出报表。" class="easyui-linkbutton easyui-tooltip" data-options="iconCls:'icon-distribution',size:'large',iconAlign:'left'"><b>导出报表</b></a><span id="exporting" style="padding:5px 0;display:inline; display:none; font-size:large">正在导出......</span></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                               <!--<div style="padding:5px 0;display:inline"><a id="report_history" style=" border:none" title="报表历史查询。" class="easyui-linkbutton easyui-tooltip" data-options="iconCls:'icon-distribution',size:'large',iconAlign:'top'"><b>报表历史查询</b></a></div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              -->
                    </td>
                </tr>
            </table> 
            ...
            <table width="100%" height="100%">
                <tr id="page_report">
                    ...
                    <td style=" width:80%">
                        ...
                        <div id="Div1" style="padding: 5px; min-height: 400px; width" border="false">
                            <table id="dg" title="报警系统等级评估" class="easyui-datagrid"  style="width:100%;height:100%;" fit="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-options="field:'plant_num',styler:cellStyler,formatter:formatValue" style="width:25%" align="left">当前值</th>
                                        <th data-options="field:'index_goal'" style="width:25%" align="left">目标值</th>
                                        <th data-options="field:'remark'" style="width:29%" align="left">备注</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
    				...
    				<!--	<div style=" text-align:left; font-size:larger;">
                            <span style=" font-weight:bold;font-size:large;">4、报警系统等级趋势分析</span><br />
                            以天为单位，报警系统的等级趋势变化。报警系统的等级目标是<span style="color:Red; font-size:larger">可预测的。</span><br />
                        </div>
					    <div id="container_level_trend" style="">
                          <ul>
                            <li><a href="#container_level_trend_1">常压炉</a></li>
                            <li><a href="#container_level_trend_2">常压塔</a></li>
                          </ul>
                          <div id="container_level_trend_1" style="height: 400px; margin: 0 auto;"></div>
...
//            showLevelTrend();
		...
		//--镇海、燕山用
		 $('#export_report_button').click(function (){
            var startTime = startDateOfGenRpt;
            var endTime = endDateOfGenRpt;
            ...
            var dg_level = JSON.stringify($('#dg').datagrid('getData').rows);
            var dg_top20 = JSON.stringify($('#dg_top20').datagrid('getData').rows);
            var dg_standing = JSON.stringify($('#dg_standing').datagrid('getData').rows);
            var dg_chattering = JSON.stringify($('#dg_chattering').datagrid('getData').rows);
            
            var chart_level = $('#container').highcharts();
            var chart_distribution_area = $('#container_distribution_area').highcharts();
            var chart_chattering = $('#container_chattering').highcharts();
            var chart_standing = $('#container_standing').highcharts();
            var chart_distribution_time = $('#container_distribution_time').highcharts();
            var chart_distribution_priority_all = $('#container_distribution_priority_all').highcharts();
            var chart_distribution_priority_area = $('#container_distribution_priority_area').highcharts();
            var chart_Top20 = $('#container_Top20').highcharts();
            $.ajax({
                url: 'alarm_analysis_report_export_data.ashx',
                type: 'post',
                data: {"plantId":'<%=plantId %>', "startTime":startTime,"endTime":endTime,
                        "svg_level":encodeURI(chart_level.getSVG()), "svg_distribution_area":encodeURI(chart_distribution_area.getSVG()),"svg_chattering":encodeURI(chart_chattering.getSVG()),"svg_standing":encodeURI(chart_standing.getSVG()),
                        "svg_distribution_time":encodeURI(chart_distribution_time.getSVG()),"svg_distribution_priority_all":encodeURI(chart_distribution_priority_all.getSVG()),"svg_distribution_priority_area":encodeURI(chart_distribution_priority_area.getSVG()),"svg_Top20":encodeURI(chart_Top20.getSVG()),
                        "dataGrid_level":encodeURI(dg_level),"dataGrid_top20":encodeURI(dg_top20),"dataGrid_standing":encodeURI(dg_standing),"dataGrid_chattering":encodeURI(dg_chattering)},
                async: true,
                ...
                success: function(data){
                    ...
                    var url = "./alarm_analysis_export.aspx?plantId=<%=plantId %>&startTime="+startDateOfGenRpt + "&endTime=" + endDateOfGenRpt;
...
//            var chart_Top20 = $('#container_Top20').highcharts();
//            $.ajax({
//                url: 'alarm_analysis_report_export_new.ashx',
//                type: 'post',
//                data: {"plantId":'<%=plantId %>', "startTime":startTime,"endTime":endTime,
//                        "svg_level":encodeURI(chart_level.getSVG()), "svg_distribution_area":encodeURI(chart_distribution_area.getSVG()),"svg_chattering":encodeURI(chart_chattering.getSVG()),"svg_standing":encodeURI(chart_standing.getSVG()),
//                        "svg_distribution_time":encodeURI(chart_distribution_time.getSVG()),"svg_distribution_priority_all":encodeURI(chart_distribution_priority_all.getSVG()),"svg_distribution_priority_area":encodeURI(chart_distribution_priority_area.getSVG()),"svg_Top20":encodeURI(chart_Top20.getSVG()),
...
//                    form.attr("method","post");
//                    //var url = "./alarm_analysis_export.aspx?plantId=<%=plantId %>&startTime="+startDateOfGenRpt + "&endTime=" + endDateOfGenRpt;
//                    var url = "./alarm_analysis_export_new.aspx?wordPath="+result.wordPath+"&wordName="+result.wordName;
//                    form.attr("action",url);
//                    
//                    $("body").append(form);//将表单放置在web中
//                    
...
//                    data: [100, 50, 20, 50]
        ...
        $('#export_report').click(function (){
            ...
            $.ajax({
                type: "post",
                url: 'alarm_analysis_report_data.ashx',
...
//                        document.getElementById('chattering_num_outline').innerHTML = total_num+"个，符合标准。";
                }
                else if(total_num < 20){
                    document.getElementById('chattering_count_order').innerHTML = total_num;
//                        document.getElementById('chattering_num_outline').innerHTML = total_num+"个，超标，目标值为0个。";
                }else{
                    document.getElementById('chattering_count_order').innerHTML = "不小于20";
//                        document.getElementById('chattering_num_outline').innerHTML = "不小于20个，超标，目标值为0个。";
                }
...
//                        document.getElementById('standing_alarm_count').innerHTML = standing_num+"个，符合标准。";
                }else if(standing_num < 20){
                    document.getElementById('standing_count_order').innerHTML = standing_num;
//                        document.getElementById('standing_alarm_count').innerHTML = standing_num+"个，超标，目标值为小于5个。";
                }else{
                    document.getElementById('standing_count_order').innerHTML = "不小于20";
//                        document.getElementById('standing_alarm_count').innerHTML = "不小于20个，超标，目标值为小于5个。";
                }
