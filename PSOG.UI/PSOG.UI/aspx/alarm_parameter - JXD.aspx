...
<!--<body   style="width:100%; "   >-->
    ...
    <span style="width:80px; height:30px;">
                                   快速查询：
                                    <select style="width:80px; height:20px; border:#999 solid 1px; position:relative;   " onchange="isRealTime(this)">
                                        <option value="1" selected="selected" style="height:16px; line-height:150%">常压炉</option>
                                        <option value="0" style="height:16px; line-height:150%">减压塔</option>                             
                                    </select>
    </span>
    ...
    <div style="overflow-y:hidden;height:390px;width:99%" id="qryDiv"  region="north"  border="false">
        ...
        <div id="gridDiv" fit="true" style="height: 340px; width:100%" border="false">
            <div id="headGrid" region="center"  style="height:340px; width:100% ">
                ...
                <table  id="fc" class="easyui-datagrid"  style="width:1000px;height:100px" url="alarm_parameter_data.ashx?plantId=<%=plantId %>" idField="tableId" 
                         pagination="false"  
                        rownumbers="false" fitColumns="true" singleSelect="true">>
                    <thead>
                            <tr>
                                 <th   field="items" width="80">位号</th>
                                 <!--<th  width="80">工段</th>-->
                                 <th  field="alarmClass" width="80">风险等级</th>
                                 <th  field="cause" width="80">可能原因</th>
                                 <th  field="effect" width="80">不良后果</th>
                                 <th  field="measure" width="80">建议措施</th>
                                 <th  field="cause" width="80">注意事项</th>
                            </tr>
                    </thead>
                </table>
                <table id="dg"  class="easyui-datagrid"  style="width:auto;height:340px"  
                        url="alarm_parameter_data.ashx?plantId=<%=plantId %>" idField="tableId" 
                         pagination="false" data-options="remoteSort:false" 
                    ...
                    <thead>
                        <tr> 
                            ...
                            <th field="value" width="80" align="right" sortable="true" data-options="sorter:numberSorter">值</th>
    ...
    { 
        ...
        detailFormatter:function(index,row){
            ...
            return '<div class="ddv" style="padding:5px 0">'+
                ...
                '<p>可能原因: ' + row.cause + '</p>' +
                '<p>建议措施: ' + row.measure + '</p>' +
                '</td>' +
                '<td style="border:0">' +
                '<p>可能后果: ' + row.effect + '</p>' +
                '<p>防范措施: ' + row.prevent + '</p>' +
                '</td>' +
                '</tr></table>'+
            '</div>';
        },
