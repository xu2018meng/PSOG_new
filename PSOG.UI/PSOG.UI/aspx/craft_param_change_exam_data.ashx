<%@ WebHandler Language="C#" Class="craft_param_change_exam_data" %>
...
public class craft_param_change_exam_data : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        EasyUIData grid = new SysManage().queryCraftParamExamList(plantId, queryReason, queryStartDate, queryEndDate,userId, pageNo, pageSize);
