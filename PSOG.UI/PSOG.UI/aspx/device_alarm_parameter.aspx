<%@ Page Language="C#" AutoEventWireup="true" CodeFile="device_alarm_parameter.aspx.cs" Inherits="device_alarm_parameter" %>
...
<head>
    <% 
       ...
       String alarmFlag = Request.QueryString["alarmFlag"];
       alarmFlag = null == alarmFlag ? "all" : alarmFlag;
        %>
...
<body   style="width:100%;overflow-y: hidden; font-size:medium;overflow-x: hidden;">
    ...
    <div style="text-align:left;height:26px;font-size:16px;padding-top:2px;background-color:#d2ebfe;font-family:微软雅黑;">
        ...
        <div id="gridDiv" fit="true" style=" width:100%; height:100%; overflow-y:hidden;overflow-x: hidden;" border="false">
            <div id="headGrid" region="center" style=" width:auto; height:100%; overflow-y: hidden;overflow-x: hidden;">
             ...
             <table id="dg"   style="overflow-x:hidden; " class="easyui-datagrid" 
                     idField="tableId"  url="device_alarm_parameter_data.ashx?plantId=<%=plantId %>&deviceId=<%=deviceId %>&alarmFlag=<%=alarmFlag %>" 
...
function makeOk(rowIndex,rowData){
     ...
     $.ajax({
            url : './device_alarm_parameter_data.ashx',
            data : {
                action:"deleteItem",
