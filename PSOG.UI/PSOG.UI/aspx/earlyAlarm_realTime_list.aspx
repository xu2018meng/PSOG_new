<%@ Page Language="C#" AutoEventWireup="true" CodeFile="earlyAlarm_realTime_list.aspx.cs" Inherits="earlyAlarm_realTime_list" %>
...
<body class="easyui-layout" onload="initGrid();">
    ...
    <div id="gridDiv"  region="center" style="width:auto;height:auto" border="false">   
      <table id="dg" style="width:auto;height:auto" fit="true" url="" idField="earlyAlarmId" 
        toolbar='#toolbar'   pagination="true" pagesize="20"  rownumbers="true"  fitColumns="true" >
         <thead>
                <tr>
                   <th data-options="field:'earlyAlarmRuleId',width:140,align:'center',halign: 'center',hidden:true">规则表主键</th>
                   <th data-options="field:'earlyAlarmBitNo',width:140,align:'center',halign: 'center',formatter:addLink">位号</th>
                   <th data-options="field:'earlyAlarmTagDesc',width:140,align:'center',halign: 'center',hidden:'true'">描述</th>
                  <th data-options="field:'earlyAlarmRealValue',width:140,align:'center',halign: 'center'">实时值</th>
                  <th data-options="field:'earlyAlarmStatus',width:140,align:'center',halign: 'center'">状态</th>
                  <th data-options="field:'earlyAlarmType',width:140,align:'center',halign: 'center'">类型</th>
                  <th data-options="field:'earlyAlarmSustainTime',width:140,align:'center',halign: 'center'">持续时间</th>
                  <th data-options="field:'earlyAlarmStartTime',width:140,align:'center',halign: 'center'">开始时间</th>
                </tr>
            </thead>
        </table>
        ...
        <div id="toolbar" style="height:72px;">
         ...
         <form id="param" action="" style="margin-top:9px;">
            ...
            <input id="queryBitNo"  class="easyui-textbox" style="height:19px;"/>
...
<script type="text/javascript"> 
   ...
   function initGrid(){
        $("#dg").datagrid({
            url:'earlyAlarm_realTime_list_data.ashx',
            queryParams: {
                plantId: '<%=plantId %>',
               tagName:'',
               typeName:''
   ...
   function clearParam(){
    ...
    function turnToAlarmRule(index){
       ...
       window.location.href ="./prealarm_survey_rule.aspx?id=" + rows[index].earlyAlarmRuleId+"&plantId=<%=plantId %>&bitCode="+rows[index].earlyAlarmBitNo+"&tagDesc="+rows[index].earlyAlarmTagDesc;
    }
