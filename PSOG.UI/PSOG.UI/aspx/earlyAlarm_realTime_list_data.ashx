<%@ WebHandler Language="C#" Class="earlyAlarm_realTime_list_data" %>
...
public class earlyAlarm_realTime_list_data : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        EasyUIData grid = new SysManage().queryEarlyAlarmRealTimeList(plantId, tagName, typeName, pageNo, pageSize);
