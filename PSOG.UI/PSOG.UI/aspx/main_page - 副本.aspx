                    ...
                    else if(jsonObj[i].name=="报警")
                    {
                       ...
                       if(1 <= len2){
                            if(undefined != document.documentMode){ //ie浏览器
                                ...
                                cell.innerHTML = "<span style='position: absolute; top: 11px; right: 7px;'>"+ len2 + "个</span>";
                            }
                            cell.style.display = "";
                        }
                         if(len2>3)
...
//                         }
        ...
        <link href="<%=contextPath %>/resource/css/mycss.css" rel="stylesheet" type="text/css" />
        <link type="text/css" rel="stylesheet" href="<%=contextPath %>/resource/css/Style.css" />
        <script language="javascript" type="text/javascript" src="<%=contextPath %>/resource/js/jquery.js"/>
         <script language="javascript" type="text/javascript" src="<%=contextPath %>/resource/js/jquery-1.6.2.min.js">
</script>
        <style type="text/css">
		    html, body {
			    width: 100%;
           ...
           <table border="0" cellpadding="5" cellspacing="0" style="width:100%;text-align:center;margin-left:auto ; margin-right:auto; border-collapse:collapse; border-spacing:0px 0px;" >
               <tr>
                   <td style="text-align:center; width: 100%;">
			        <table style="margin-left:auto ; margin-right:auto; padding:0px; border-collapse:collapse; border-spacing:0px 0px; border: solid 1px rgb(225,224,228); height:131px; width:965px;" id="table2">
                        <tr style=" border-collapse:collapse; border-spacing:0px 0px;  padding:0px;">
                             <td  style="width:150px; background-color: RGB(246,246,246); text-align:center; vertical-align:middle;"> 
                                <img src='<%=contextPath %>/resource/img/plantMain/gyjc.png' onclick="imgClick('<%=plantId %>', '002')"  alt="工艺" style="width: 116px; height: 115px; cursor:pointer" id="IMG1"  /></td>
                    ...
                    <br />
                    <table style="text-align:left;margin-left:auto ; margin-right:auto; width: auto; height:116px;width: 965px; border-collapse:collapse; border-spacing:0px 0px; border: solid 1px rgb(225,224,228);" id="table3">
                        <tr>
                            <td style="text-align:left;width:150px; background-color: RGB(246,246,246); text-align:center; vertical-align:middle;"> 
                                <img src='<%=contextPath %>/resource/img/plantMain/sbjc.png'  onclick="imgClick('<%=plantId %>', '003')" alt="设备" style="width: 116px; height: 116px; cursor:pointer" />
                                </td>
                    ...
                    <table  id="table4" style="text-align:left;margin-left:auto ; margin-right:auto; width: auto; height:116px;width: 965px; border-collapse:collapse; border-spacing:0px 0px; padding:0px;">
                        <tr style="border: solid 1px rgb(225,224,228);">
                            <td rowspan="2" style="text-align:left; width: 150px; background-color: RGB(246,246,246); text-align:center; vertical-align:middle;padding:0px;position:relative;"> 
                                <img  src='<%=contextPath %>/resource/img/plantMain/bjfx.png'  onclick="imgClick('<%=plantId %>', '004')" alt="报警" style="width: 116px; height: 116px;cursor:pointer" />
                                <label style="font-size:small;color:White; font-family: 微软雅黑; width:41px; height: 41px; position:absolute; cursor:pointer; right:15px; top:8px; display:none; background-image: url(../resource/img/mainPage/showAlarmNum.png); "  onclick="imgClick('<%=plantId %>', '004')" id="Alarmcount" ></label>
                            </td>
                            <td style="text-align: left; font-family: 微软雅黑;padding:0px; vertical-align:top;" >
                                ...
                                <table  id="Alarmtable"  style="text-align:center; display: inline; border-collapse:collapse; border-spacing:0px 0px; width:100%; padding:0px; ">
                                    <tr style="background-image:url(../resource/img/plantMain/tab_top_bg.gif); height: 25px; background-repeat:repeat-x; padding:0px; height: 25px; ">
