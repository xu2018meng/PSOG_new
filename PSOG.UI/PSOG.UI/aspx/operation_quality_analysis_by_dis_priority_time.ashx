<%@ WebHandler Language="C#" Class="operation_quality_analysis_by_dis_priority_time" %>
...
public class operation_quality_analysis_by_dis_priority_time : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            grid = new OQIAnalysis().OQIDistributionByPriorityTime(startTime, endTime, DBName);
        }
