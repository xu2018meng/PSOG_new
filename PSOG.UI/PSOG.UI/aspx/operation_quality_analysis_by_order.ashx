<%@ WebHandler Language="C#" Class="operation_quality_analysis_by_order" %>
...
public class operation_quality_analysis_by_order : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            grid = new OQIAnalysis().OQIAnalysis_order(id, startTime, endTime, DBName);
        }
