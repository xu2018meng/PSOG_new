<%@ WebHandler Language="C#" Class="operation_quality_analysis_by_passrate_time" %>
...
public class operation_quality_analysis_by_passrate_time : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            grid = new OQIAnalysis().OQIDistributionByPassrateTime(startTime, endTime, DBName);
        }
