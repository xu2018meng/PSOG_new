<%@ WebHandler Language="C#" Class="operation_quality_analysis_by_score" %>
...
public class operation_quality_analysis_by_score : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            grid = new OQIAnalysis().OQIAnalysis_score(id, startTime, endTime, DBName);
        }
