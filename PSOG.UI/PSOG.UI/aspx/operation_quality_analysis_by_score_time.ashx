<%@ WebHandler Language="C#" Class="operation_quality_analysis_by_score_time" %>
...
public class operation_quality_analysis_by_score_time : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            grid = new OQIAnalysis().OQIDistributionByScoreTime(startTime, endTime, DBName);
        }
