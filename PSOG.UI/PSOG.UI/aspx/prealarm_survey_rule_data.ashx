<%@ WebHandler Language="C#" Class="prealarm_survey_rule_data" %>
...
public class prealarm_survey_rule_data : IHttpHandler
{
    public void ProcessRequest (HttpContext context) {
        ...
        String message = new SysManage().saveEarlyAlarmRule(id, plantId, rule,time1, man1, manName1, 
