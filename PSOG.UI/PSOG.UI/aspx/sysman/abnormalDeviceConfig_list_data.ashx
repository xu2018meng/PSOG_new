<%@ WebHandler Language="C#" Class="abnormalDeviceConfig_list_data" %>
...
public class abnormalDeviceConfig_list_data : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (string.IsNullOrEmpty(parentId))
        {
            ...
            EasyUIData grid = new EasyUIData();
            grid = new SysManage().queryHasDeviceAbnormalList(parentId, tagName,pageNo, pageSize);
