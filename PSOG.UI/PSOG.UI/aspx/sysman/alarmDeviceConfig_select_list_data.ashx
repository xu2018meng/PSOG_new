<%@ WebHandler Language="C#" Class="alarmDeviceConfig_select_list_data" %>
...
public class alarmDeviceConfig_select_list_data : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        EasyUIData grid = new SysManage().queryHavingDeviceAlarmList(parentId,tagName,deviceName,pageNo,pageSize);
