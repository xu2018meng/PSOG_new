<%@ WebHandler Language="C#" Class="alarm_limit_list_data" %>
...
public class alarm_limit_list_data : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (string.IsNullOrEmpty(parentId))
        {
            ...
            EasyUIData grid = new EasyUIData();
            grid = new SysManage().queryAlarmLimitList(parentId, tagName, deviceName, pageNo, pageSize);
