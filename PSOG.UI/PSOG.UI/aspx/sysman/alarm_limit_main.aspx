<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alarm_limit_main.aspx.cs" Inherits="alarm_limit_main" %>
...
<body class="easyui-layout" border="1" >
    <form id="form1" action="">
        ...
        <div data-options="region:'west'"  style="width:177px;  position:relative; height:100%; overflow:hidden; " border="true">
	        <iframe id="left_frame" name="left_frame" src="alarm_limit_tree.aspx" style="overflow:hidden; position:absolute;" scrolling="no"  height="100%" width="170px" frameborder="0"></iframe>
	    </div>
    	
	    <div data-options="region:'center'" border="true" style="position:relative; height:100%;overflow:hidden;">
		    <%-- 主内容 aspx/main_page.aspx --%>
	        <iframe id="main-region" name="main-region" src="alarm_limit_list.aspx"  height="100%" width="100%"  frameborder="0"></iframe>	    
	    </div>
    </form>
</body>
</html>
