<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bit_select_list.aspx.cs" Inherits="aspx_sysman_bit_select_list" %>
        ...
        toolbar='#toolbar'   pagination="true" pagesize="10"  rownumbers="true"  fitColumns="true" >
         <thead>
                <tr>
                  ...
                  <th data-options="field:'belongLineId',width:140,align:'left',halign: 'center',hidden:true">所属工段</th>
                  <th data-options="field:'belongDeviceId',width:140,align:'left',halign: 'center',hidden:true">所属设备</th>
                </tr>
            </thead>
        </table>
   ...
   function confirmSelectBit(){
     ...
     for(var i=0;i<rows.length;i++){
       arr.push({
         ...
         belongLineId:rows[i].belongLineId,
         belongDeviceId:rows[i].belongDeviceId
       });
     }
     
      $.ajax({
            url : './bit_select_confirm_data.ashx',
            data : {
              parentId:typeId,
