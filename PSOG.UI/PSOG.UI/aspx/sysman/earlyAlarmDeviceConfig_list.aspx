<%@ Page Language="C#" AutoEventWireup="true" CodeFile="earlyAlarmDeviceConfig_list.aspx.cs" Inherits="earlyAlarmDeviceConfig_list" %>
...
<head id="Head1">
    ...
    <script type="text/javascript">
      function initGrid(){
           ...
           $("#dg").datagrid({
            url:'earlyAlarmDeviceConfig_list_data.ashx',
            queryParams: {
                parentId: '',
                tagName:'',
                tagDesc:''
...
<body class="easyui-layout" onload="initGrid();">
    ...
    <div id="bitDiv" class="easyui-dialog" closed="true" title="预警点选择" style="width: 700px; height: 450px; overflow: hidden" buttons="#bitDiv-buttons" modal="true">
        <iframe id='BitGrid' name="BitGrid" src="earlyAlarmDeviceConfig_select_list.aspx" style="width: 100%; height: 100%; border: 0; overflow-x: hidden;"></iframe>
...
<script type="text/javascript"> 
    ...
    function append(){
         ...
         $('#bitDiv').dialog({
               onClose:function(){
                 $("#BitGrid").attr("src","earlyAlarmDeviceConfig_select_list.aspx");
               }
             }).dialog('open').dialog('setTitle', '预警点选择');
    ...
    function removeit(){
         ...
         $.messager.confirm('Confirm', '确定要删除吗?', function (r) {
           if(r){
               $.ajax({
                    url : './earlyAlarmDeviceConfig_select_confirm_data.ashx',
                    data : {
                      flag:"delete",
                      parentId:nodeId,
