<%@ WebHandler Language="C#" Class="earlyAlarmDeviceConfig_list_data" %>
...
public class earlyAlarmDeviceConfig_list_data : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if (string.IsNullOrEmpty(parentId))
        {
            ...
            EasyUIData grid = new EasyUIData();
            grid = new SysManage().queryHasDeviceEarlyAlarmList(parentId, tagName, tagDesc, pageNo, pageSize);
