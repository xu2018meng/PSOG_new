<%@ Page Language="C#" AutoEventWireup="true" CodeFile="earlyAlarmDeviceConfig_main.aspx.cs" Inherits="earlyAlarmDeviceConfig_main" %>
...
<body class="easyui-layout" border="1" >
    <form id="form1" action="">
	    ...
	    <div data-options="region:'center'" border="true" style="position:relative; height:100%;overflow:hidden;">
	        ...
	        <iframe id="main-region" name="main-region" src="earlyAlarmDeviceConfig_list.aspx"  height="100%" width="100%"  frameborder="0"></iframe>	    
	    </div>
    </form>
</body>
</html>
