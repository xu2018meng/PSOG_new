<%@ WebHandler Language="C#" Class="earlyAlarmDeviceConfig_select_list_data" %>
...
public class earlyAlarmDeviceConfig_select_list_data : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        EasyUIData grid = new SysManage().queryHavingDeviceEarlyAlarmList(parentId, tagName, deviceName, pageNo, pageSize);
