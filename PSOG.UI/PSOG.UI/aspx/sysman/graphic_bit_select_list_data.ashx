<%@ WebHandler Language="C#" Class="graphic_bit_select_list_data" %>
...
public class graphic_bit_select_list_data : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        EasyUIData grid = new SysManage().queryGraphicSelectingBit(parentId, tagName, deviceName, pageNo, pageSize);
