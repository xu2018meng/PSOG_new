<%@ Page Language="C#" AutoEventWireup="true" CodeFile="menu_manage_main.aspx.cs" Inherits="aspx_sysman_menu_manage_main" %>
...
<body class="easyui-layout" border="1" >
    <form id="form1" action="">
        ...
        <div data-options="region:'west'"  style="width:177px;  position:relative; height:100%; overflow:hidden; " border="true">
	        <iframe id="left_frame" name="left_frame" src="menu_tree.aspx" style="overflow:hidden; position:absolute;" scrolling="no"  height="100%" width="170px" frameborder="0"></iframe>
	    </div>
    	
	    <div data-options="region:'center'" border="true" style="position:relative; height:100%;overflow:hidden;">
		    <%-- 主内容 aspx/main_page.aspx --%>
	        <iframe id="main-region" src="menu_manage_list.aspx"  height="100%" width="100%"  frameborder="0"></iframe>	    
	    </div>
    </form>
</body>
</html>
<script type="text/javascript">
function showMenuList(menuCode, nodeType){
    window.frames["main-region"].reloadGrid(menuCode, nodeType);
}
