<%@ Page Language="C#" AutoEventWireup="true" CodeFile="role_menu_relation.aspx.cs" Inherits="aspx_sysman_role_menu_relation" %>
...
<body class="easyui-layout" border="1" >
    <form id="form1" action="">
        ...
        <div data-options="region:'west'"  style="width:177px;  position:relative; height:100%; overflow:hidden; " border="true">
	        <iframe id="left_frame" name="left_frame" src="role_tree_forMenu.aspx" style="overflow:hidden; position:absolute;" scrolling="no"  height="100%" width="170px" frameborder="0"></iframe>
	    </div>
...
function showMenuTree(roleId){
    if("-1" == roleId)  //不需要展示菜单页
    {
        ...
        document.all("main-region").src = "menu_tree_for_role_menu.aspx?roleId=" + roleId;
    }
