<%@ Page Language="C#" AutoEventWireup="true" CodeFile="section_equip_Config_tree.aspx.cs" Inherits="section_equip_Config_tree" %>
...
<script type="text/javascript">
    $('#tt').tree({
        ...
        onClick: function (node){
            ...
            parent.showBitList(node.id,nodeType,node);
        },
    ...
    function getChildNodes(nodeId,nodeType){
        var node = "";
        $.ajax({
            url:'section_equip_Config_tree_data.ashx',
