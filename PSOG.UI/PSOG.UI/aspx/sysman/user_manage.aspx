<%@ Page Language="C#" AutoEventWireup="true" CodeFile="user_manage.aspx.cs" Inherits="aspx_sysman_user_manage" %>
...
<script type="text/javascript">
    ...
    $('#tt').tree({
        ...
        onClick: function (node){
            ...
            var parentCode = "";
            if(null != parentNode){
                var parentNodeAttr = parentNode.attributes.split(":");
                if("ORGAN" == parentNodeAttr[1]){
                    parentCode = parentNode.id;
                }
            }
            parent.window.showUserList(parentCode, node.id,nodeInfo[1]);
        },
