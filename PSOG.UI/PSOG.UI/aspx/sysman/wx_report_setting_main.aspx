<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wx_report_setting_main.aspx.cs" Inherits="wx_report_setting_main" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head>
    <title>微信报表推送配置</title>
    <% 
         %>
...
<body class="easyui-layout" border="1" >
    <form id="form1" action="">
        ...
        <div data-options="region:'west'"  style="width:177px;  position:relative; height:100%; overflow:hidden; " border="true">
	        <iframe id="left_frame" name="left_frame" src="wx_report_setting_tree.aspx" style="overflow:hidden; position:absolute;" scrolling="no"  height="100%" width="170px" frameborder="0"></iframe>
	    </div>
...
function showSettingInfo(id, nodeType){
    if("plant" == nodeType)  
    {
        document.all("main-region").src = "wx_report_setting_info.aspx?plantId=" + id;
    }
    else{
