<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tree_plant_new.aspx.cs" Inherits="aspx_tree_plant_new" %>
...
<body style="margin:0px; padding:0px; overflow:hidden; background-color:#d1e5f0; background-position:left bottom; width:210px; height:100%;">
  ...
  $(function(){
   ...
   $('#tt').tree({
        ...
        onClick: function (node){
            var nodeType = node.attributes.split(":")[1];
            parent.showMainPage(node.id,nodeType,node.text,node.attributes.split(":")[0]);
        },
