(function($) {
    ...
    $.fn.contextmenu = function(option) {
        ...
        itemTpl = "<div class='b-m-$[type]' unselectable=on><nobr class='b-m-nobr' unselectable=on><img src='$[icon]' align='absmiddle'/><span unselectable=on align='absmiddle'>$[text]</span></nobr></div>";
        ...
        var showMenuGroup = function(pos, width) {
        	...
        	//change by zhen form "body" to document 处理页面实际宽度不准确问题
