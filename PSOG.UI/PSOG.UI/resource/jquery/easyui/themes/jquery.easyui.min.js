...
},plugins:["_draggable","droppable","_resizable","pagination","_tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window","dialog","form"],parse:function(_2){
var aa=[];
...
$.fn._draggable=function(_4c,_4d){
if(typeof _4c=="string"){
return $.fn._draggable.methods[_4c](this,_4d);
}
return this.each(function(){
var _4e;
var _4f=$.data(this,"_draggable");
if(_4f){
_4f.handle.unbind("._draggable");
_4e=$.extend(_4f.options,_4c);
}else{
_4e=$.extend({},$.fn._draggable.defaults,$.fn._draggable.parseOptions(this),_4c||{});
}
var _50=_4e.handle?(typeof _4e.handle=="string"?$(_4e.handle,this):_4e.handle):$(this);
$.data(this,"_draggable",{options:_4e,handle:_50});
if(_4e.disabled){
$(this).css("cursor","");
return;
}
_50.unbind("._draggable").bind("mousemove._draggable",{target:this},function(e){
if($.fn._draggable.isDragging){
return;
}
var _51=$.data(e.data.target,"_draggable").options;
if(_52(e)){
...
$.extend(e.data,_55);
var _56=$.data(e.data.target,"_draggable").options;
...
function _52(e){
var _57=$.data(e.data.target,"_draggable");
var _58=_57.handle;
var _59=$(_58).offset();
...
$.fn._draggable.parseOptions=function(_5c){
var t=$(_5c);
...
(function($){
$.fn._resizable=function(_6b,_6c){
if(typeof _6b=="string"){
return $.fn._resizable.methods[_6b](this,_6c);
}
function _6d(e){
var _6e=e.data;
var _6f=$.data(_6e.target,"_resizable").options;
...
return this.each(function(){
var _77=null;
var _78=$.data(this,"_resizable");
if(_78){
$(this).unbind("._resizable");
_77=$.extend(_78.options,_6b||{});
}else{
_77=$.extend({},$.fn._resizable.defaults,$.fn._resizable.parseOptions(this),_6b||{});
$.data(this,"_resizable",{options:_77});
}
...
$(document).bind("mousedown._resizable",_7b,_74);
$(document).bind("mousemove._resizable",_7b,_75);
$(document).bind("mouseup._resizable",_7b,_76);
...
$.fn._resizable.parseOptions=function(_82){
var t=$(_82);
...
_e6.disabledNodes=[];
_e7.dnd=true;
_e8.find("div.tree-node")._draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_e9){
...
var _fd=$(_fb)._draggable("proxy").find("span.tree-dnd-icon");
...
_276.window._draggable({handle:">div.panel-header>div.panel-title",disabled:_276.options._draggable==false,onStartDrag:function(e){
if(_276.mask){
...
_276.window._resizable({disabled:_276.options._resizable==false,onStartResize:function(e){
if(_276.pmask){
_276.pmask.remove();
}
...
return $.extend({},$.fn.panel.parseOptions(_27e),$.parser.parseOptions(_27e,[{_draggable:"boolean",_resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
...
function _294(_295){
var opts=$.extend({},$.fn.window.defaults,{collapsible:false,minimizable:false,maximizable:false,shadow:false,_draggable:false,_resizable:false,closed:true,style:{left:"",top:"",right:0,zIndex:$.fn.window.defaults.zIndex++,bottom:-document.body.scrollTop-document.documentElement.scrollTop},onBeforeOpen:function(){
...
win.window({title:_297,noheader:(_297?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,_resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
_392._resizable($.extend({},{handles:_393,onStartResize:function(e){
_37d=true;
...
_5ca.each(function(){
$(this)._resizable({handles:_5cd,disabled:($(this).attr("_resizable")?$(this).attr("_resizable")=="false":false),minWidth:25,onStartResize:function(e){
_5c7.resizing=true;
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,_resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,_resizable:false}]],showGroup:false,groupView:_7b5,groupField:"group",groupFormatter:function(_7f2,rows){
return _7f2;
}});
})(jQuery);
(function($){
...
_a13.find("a.slider-handle")._draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
